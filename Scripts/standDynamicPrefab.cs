...
using UnityEngine.XR.ARSubsystems;
    ...
    public class standDynamicPrefab : MonoBehaviour
    {
        ...
        void OnGUI()
        {
            ...
            switch (m_State)
            {
                ...
                {
                    if (GUILayout.Button($"Alternative Prefab for {GetComponent<standPrefabImagePairManager>().imageLibrary[0].name}"))
                    {
                ...
                {
                    if (GUILayout.Button($"Original Prefab for {GetComponent<standPrefabImagePairManager>().imageLibrary[0].name}"))
                    {
