...
[RequireComponent(typeof(ARTrackedImageManager))]
    public class PrefabManager : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        void OnTrackedImagesChanged(ARTrackablesChangedEventArgs<ARTrackedImage> eventArgs)
        {
            ...
            {
                //print($"{trackedImage.referenceImage.size} {trackedImage.referenceImage.name} added");
            ...
            {
                //print($"{m_Instantiated[trackedImage.Value.referenceImage.guid].gameObject.name} remove");
    ...
    private void UpdatePrefab(ARTrackedImage trackedImage)
    {
        ...
        foreach (var item in m_Instantiated.Keys)
        {
